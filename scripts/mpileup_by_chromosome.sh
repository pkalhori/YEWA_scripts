...
bcftools mpileup -Ou -f $ref_fasta -r $contig -b $all_bams | bcftools call -m -Oz -o /home/pkalhori/mpileup/calls_mywa_geo_alignment/all_samples_chromosome_${contig}.vcf.gz &
