...
contig_file=/home/pkalhori/mywa_geo_sex_chromosomes_list.txt
...
output=${wd}/all_samples_chromosome_${contig}_filtered_temp.vcf.gz
...
output=${wd}/all_samples_chromosome_${contig}_filtered_temp.vcf.gz
output_MQ=${wd}/all_samples_chromosome_${contig}_filtered_MQ20.vcf
...
#output=${wd}/all_samples_chromosome_${contig}_filtered.vcf.gz
#input_MQ=${wd}/all_samples_chromosome_${contig}_filtered_MQ20.vcf
