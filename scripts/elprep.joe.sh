...
echo nohup elprep filter $input $output --mark-duplicates -mark-optical-duplicates $metrics --sorting-order coordinate --bqsr $recal --reference $ref_fasta --haplotypecaller $vcf 
echo elprep run
sleep 10 &
